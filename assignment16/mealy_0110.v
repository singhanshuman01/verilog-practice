...
module mealy_0110 (
    ...
    always @(*) begin
        ...
        case (state)
            ...
            S2: begin
                if (in) begin next_state = S3; out = 0; end
                else    begin next_state = S1; out = 0; end
            end
            S3: begin
                if (in) begin next_state = S2; out = 0; end
...
module mealy_0110_tb;
    ...
    mealy_0110 dut (.clk(clk), .rst(rst), .in(in), .out(out));
    ...
    initial begin
        ...
        $display("==========================================================");
        $display("  MEALY FSM 6: Detect pattern 0110");
        $display("  Stream: 0 1 1 0 1 0 1 1 0");
        $display("==========================================================");
