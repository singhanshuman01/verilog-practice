...
module mealy_palindrome (
    ...
    always @(*) begin
        ...
        case (state)
            ...
            S3: begin
                if (in) begin next_state = S0; out = 1; end  // 1001 palindrome!
                else    begin next_state = S0; out = 0; end
            end
        endcase
    end
...
module mealy_palindrome_tb;

    reg  clk, rst, in;
    wire out;

    mealy_palindrome dut (.clk(clk), .rst(rst), .in(in), .out(out));
